...
def create_sms_service(app_config: AppConfig, provider: str, http_service: HttpService | None = None) -> BaseSmsService:
    """创建短信服务。"""
    ...
    if provider == "herosms":
        ...
        return HeroSmsService(app_config.herosms, http_service)
