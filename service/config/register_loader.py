...
def _parse_openai_sms_config(openai_register_table: dict[str, Any]) -> dict[str, Any]:
    sms_config_table = openai_register_table.get("sms_config")
    return sms_config_table
...
def parse_openai_register_config(registers_table: dict[str, Any], base_dir: Path) -> OpenAIRegisterConfig:
    ...
    sms_provider = parse_optional_nullable_str(
        openai_register_table.get("sms_provider"),
        field_name="registers.openai.sms_provider",
        default=None,
    )
    sms_config = _parse_openai_sms_config(openai_register_table)
